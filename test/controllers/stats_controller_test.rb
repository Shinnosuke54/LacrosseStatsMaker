...
class StatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stat" do
    assert_difference("Stat.count") do
      post stats_url, params: { stat: { bd: @stat.bd, gb: @stat.gb, name: @stat.name, pc: @stat.pc, score: @stat.score, shot: @stat.shot } }
    end
  ...
  test "should update stat" do
    patch stat_url(@stat), params: { stat: { bd: @stat.bd, gb: @stat.gb, name: @stat.name, pc: @stat.pc, score: @stat.score, shot: @stat.shot } }
